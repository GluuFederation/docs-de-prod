...
- Stable: N/A
- Unstable: `gluufederation/oxtrust:4.0.0_dev`.

Refer to [Changelog](https://github.com/GluuFederation/docker-oxtrust/blob/4.0.0/CHANGES.md) for details on new features, bug fixes, or older releases.
