...
[Here](https://github.com/GluuFederation/gluu-docker/tree/3.1.5/examples/multi-hosts) are the instructions to deploy clustered instances of Gluu Server Docker containers.
